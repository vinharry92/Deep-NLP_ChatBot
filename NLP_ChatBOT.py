...
threshold = 20 # Minimum number to be accepted
...
# checkpoint = 'D:/NL_Tensorflow/chatbot_weights.ckpt'
...
#     # answer = ''
#     # prediction=tf.argmax(predicted_answer,1)
#     # print(prediction.eval())

#     for i in np.argmax(predicted_answer, 1):
#         if answersints2word[i] == 'i':
#             token = 'I'
#         if answersints2word[i] == '<EOS>':
#             token = '.'
